...
class DataBahasa extends Model
{
    /** @use HasFactory<\Database\Factories\DataBahasaFactory> */
    ...
    {
        return $this->hasMany(Penduduk::class, 'bahasa_id');
    }
