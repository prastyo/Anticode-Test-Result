...
class DataTempatDilahirkan extends Model
{
    /** @use HasFactory<\Database\Factories\DataTempatDilahirkanFactory> */
     ...
     */
    protected $table    = 'data_tempat_dilahirkan';
    ...
    {
        return $this->hasMany(Kelahiran::class, 'tempat_dilahirkan_id');
    }
