...
class DataJenisPersalinan extends Model
{
    /** @use HasFactory<\Database\Factories\DataJenisPersalinanFactory> */
     ...
     */
    protected $table    = 'data_jenis_persalinan';
    ...
    {
        return $this->hasMany(Kelahiran::class, 'jenis_persalinan_id');
    }
