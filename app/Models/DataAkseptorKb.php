...
class DataAkseptorKb extends Model
{
    /** @use HasFactory<\Database\Factories\DataAkseptorKbFactory> */
     ...
     */
    protected $table    = 'data_akseptor_kb';
    ...
    {
        return $this->hasMany(Penduduk::class, 'akseptor_kb_id');
    }
