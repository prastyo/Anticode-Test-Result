...
class DataPenolongKelahiran extends Model
{
    /** @use HasFactory<\Database\Factories\DataPenolongKelahiranFactory> */
     ...
     */
    protected $table    = 'data_penolong_kelahiran';
    ...
    {
        return $this->hasMany(Kelahiran::class, 'penolong_kelahiran_id');
    }
