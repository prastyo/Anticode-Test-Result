...
class DataKawinExcel implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithEvents, WithColumnFormatting, WithProperties
{
    use Exportable;
    ...
    {
        return DataKawin::query();

/*
        // TODO : Has -> WhereHas -> orWhereHas
        return DataKawin::query()query()->where([
