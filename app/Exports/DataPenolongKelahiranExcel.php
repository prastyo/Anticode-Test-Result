...
class DataPenolongKelahiranExcel implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithEvents, WithColumnFormatting, WithProperties
{
    use Exportable;
    ...
    {
        return DataPenolongKelahiran::query();

/*
        // TODO : Has -> WhereHas -> orWhereHas
        return DataPenolongKelahiran::query()query()->where([
