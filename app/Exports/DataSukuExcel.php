...
class DataSukuExcel implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithEvents, WithColumnFormatting, WithProperties
{
    use Exportable;
    ...
    {
        return DataSuku::query();

/*
        // TODO : Has -> WhereHas -> orWhereHas
        return DataSuku::query()query()->where([
            ['nama', 'LIKE', '%' . $this->search_query . '%'],
            ['deskripsi', 'LIKE', '%' . $this->search_query . '%']
        ])
