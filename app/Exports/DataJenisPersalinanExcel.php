...
class DataJenisPersalinanExcel implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithEvents, WithColumnFormatting, WithProperties
{
    use Exportable;
    ...
    {
        return DataJenisPersalinan::query();

/*
        // TODO : Has -> WhereHas -> orWhereHas
        return DataJenisPersalinan::query()query()->where([
