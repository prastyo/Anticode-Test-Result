...
class DataBahasaExcel implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithEvents, WithColumnFormatting, WithProperties
{
    use Exportable;
    ...
    {
        return DataBahasa::query();

/*
        // TODO : Has -> WhereHas -> orWhereHas
        return DataBahasa::query()query()->where([
            ['nama', 'LIKE', '%' . $this->search_query . '%'],
            ['inisial', 'LIKE', '%' . $this->search_query . '%']
        ])
