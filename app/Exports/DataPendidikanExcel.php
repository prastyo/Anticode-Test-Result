...
class DataPendidikanExcel implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithEvents, WithColumnFormatting, WithProperties
{
    use Exportable;
    ...
    {
        return DataPendidikan::query();

/*
        // TODO : Has -> WhereHas -> orWhereHas
        return DataPendidikan::query()query()->where([
