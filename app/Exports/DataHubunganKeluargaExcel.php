...
class DataHubunganKeluargaExcel implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithEvents, WithColumnFormatting, WithProperties
{
    use Exportable;
    ...
    {
        return DataHubunganKeluarga::query();

/*
        // TODO : Has -> WhereHas -> orWhereHas
        return DataHubunganKeluarga::query()query()->where([
