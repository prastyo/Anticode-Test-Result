...
class DataJabatanExcel implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithEvents, WithColumnFormatting, WithProperties
{
    use Exportable;
    ...
    {
        return DataJabatan::query();

/*
        // TODO : Has -> WhereHas -> orWhereHas
        return DataJabatan::query()query()->where([
