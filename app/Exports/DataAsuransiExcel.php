...
class DataAsuransiExcel implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithEvents, WithColumnFormatting, WithProperties
{
    use Exportable;
    ...
    {
        return DataAsuransi::query();

/*
        // TODO : Has -> WhereHas -> orWhereHas
        return DataAsuransi::query()query()->where([
