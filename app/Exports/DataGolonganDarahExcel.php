...
class DataGolonganDarahExcel implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithEvents, WithColumnFormatting, WithProperties
{
    use Exportable;
    ...
    {
        return DataGolonganDarah::query();

/*
        // TODO : Has -> WhereHas -> orWhereHas
        return DataGolonganDarah::query()query()->where([
