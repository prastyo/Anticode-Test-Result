...
class DataStatusDasarExcel implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithEvents, WithColumnFormatting, WithProperties
{
    use Exportable;
    ...
    {
        return DataStatusDasar::query();

/*
        // TODO : Has -> WhereHas -> orWhereHas
        return DataStatusDasar::query()query()->where([
