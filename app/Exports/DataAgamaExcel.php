...
class DataAgamaExcel implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithEvents, WithColumnFormatting, WithProperties
{
    use Exportable;
    ...
    {
        return DataAgama::query();

/*
        // TODO : Has -> WhereHas -> orWhereHas
        return DataAgama::query()query()->where([
