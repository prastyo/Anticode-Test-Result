...
class DataSakitMenahunExcel implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithEvents, WithColumnFormatting, WithProperties
{
    use Exportable;
    ...
    {
        return DataSakitMenahun::query();

/*
        // TODO : Has -> WhereHas -> orWhereHas
        return DataSakitMenahun::query()query()->where([
