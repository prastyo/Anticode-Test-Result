...
class DataCacatExcel implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithEvents, WithColumnFormatting, WithProperties
{
    use Exportable;
    ...
    {
        return DataCacat::query();

/*
        // TODO : Has -> WhereHas -> orWhereHas
        return DataCacat::query()query()->where([
