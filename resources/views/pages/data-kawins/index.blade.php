 ...
 */
?>
@extends('layouts.app', ['title' => __('data_kawin') ])
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ __('data_kawin') }}</div>
            </div>
        </div>
                        ...
                        <div class="mb-3 row">
                            <div class="col-sm-12 col-md-6">
                                ...
                                <button type="button" class="btn btn-icon icon-left btn-primary mr-2"
                                    ...
                                    {{ __('site.add') }} {{ __('data_kawin') }}
                                </button>
                                @endcan

                                @can('trash_data_kawin')
                            ...
                            <form action="{{ route('data-kawins.excel') }}" method="POST">
                                    @csrf
                                ...
                                <form action="{{ route('data-kawins.print') }}" target="_blank" method="POST">
                                    @csrf
                                ...
                                <form action="{{ route('data-kawins.pdf') }}" method="POST">
                                    @csrf
...
@can('create_data_kawin')
<!-- modal add -->@include('pages.data-kawins.modal-add')
<!-- end modal add -->
@endcan

@can('edit_data_kawin')
<!-- modal edit -->@include('pages.data-kawins.modal-edit')
<!-- end modal edit -->
@endcan

<!-- modal detail -->@include('pages.data-kawins.modal-detail')
<!-- end modal detail -->
@can('delete_data_kawin')
...
var table = $('#table_datatables').DataTable({
    ...
    ajax: {
        url: '{{ route('data-kawins.datatables') }}',
        type: 'POST',
