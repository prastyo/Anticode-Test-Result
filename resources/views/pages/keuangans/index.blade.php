 ...
 */
?>
@extends('layouts.app', ['title' => __('keuangan') ])
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ __('keuangan') }}</div>
            </div>
        </div>
                ...
                <div class="card card-primary">
                    <div class="card-body">
                        <div class="mb-3 row">
                            ...
                            <form action="{{ route('keuangans.excel') }}" method="POST">
                                    @csrf
                                ...
                                <form action="{{ route('keuangans.print') }}" target="_blank" method="POST">
                                    @csrf
                                ...
                                <form action="{{ route('keuangans.pdf') }}" method="POST">
                                    @csrf
                        ...
                        <div class="table-responsive">
                            <table id="table_datatables" class="table">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>{{ __('tahun_anggaran') }}</th>
                                        <th>{{ __('jenis_keuangan') }}</th>
                                        <th>{{ __('nilai_anggaran') }}</th>
                                        <th>{{ __('nilai_realisasi') }}</th>
                                        <th>{{ __('keterangan') }}</th>
                                        <th>{{ __('tanggal_kuitansi') }}</th>
...
@can('create_keuangan')
<!-- modal add -->@include('pages.keuangans.modal-add')
<!-- end modal add -->
@endcan

@can('edit_keuangan')
<!-- modal edit -->@include('pages.keuangans.modal-edit')
<!-- end modal edit -->
@endcan

<!-- modal detail -->@include('pages.keuangans.modal-detail')
<!-- end modal detail -->
@can('delete_keuangan')
...
var table = $('#table_datatables').DataTable({
    ...
    ajax: {
        url: '{{ route('keuangans.datatables') }}',
        type: 'POST',
    ...
    columns: [
        ...
        { data: 'jenis_keuangan', name: 'jenis_keuangan' },
        { data: 'nilai_anggaran', name: 'nilai_anggaran', searchable: false },
        { data: 'nilai_realisasi', name: 'nilai_realisasi', searchable: false },
        { data: 'keterangan', name: 'keterangan' },
        { data: 'tanggal_kuitansi', name: 'tanggal_kuitansi' },
        {
            data: 'action',
            name: 'action',
            orderable: false,
