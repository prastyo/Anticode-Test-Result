 ...
 */
?>
@extends('layouts.app', ['title' => __('perangkat') ])
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ __('perangkat') }}</div>
            </div>
        </div>
                ...
                <div class="card card-primary">
                    <div class="card-body">
                        <div class="mb-3 row">
                            ...
                            <form action="{{ route('perangkats.excel') }}" method="POST">
                                    @csrf
                                ...
                                <form action="{{ route('perangkats.print') }}" target="_blank" method="POST">
                                    @csrf
                                ...
                                <form action="{{ route('perangkats.pdf') }}" method="POST">
                                    @csrf
                        ...
                        <div class="table-responsive">
                            <table id="table_datatables" class="table">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>{{ __('penduduk_nama') }}</th>
                                        <th>{{ __('penduduk_nik') }}</th>
                                        <th>{{ __('jabatan') }}</th>
                                        <th>{{ __('nipd') }}</th>
                                        <th>{{ __('nip') }}</th>
                                        <th>{{ __('pangkat_golongan') }}</th>
                                        <th>{{ __('no_keputusan_pengangkatan') }}</th>
                                        <th>{{ __('tanggal_keputusan_pengangkatan') }}</th>
                                        <th>{{ __('no_keputusan_pemberhentian') }}</th>
                                        <th>{{ __('tanggal_keputusan_pemberhentian') }}</th>
                                        <th>{{ __('status_pejabat') }}</th>
                                        <th>{{ __('masa_jabatan') }}</th>
...
@can('create_perangkat')
<!-- modal add -->@include('pages.perangkats.modal-add')
<!-- end modal add -->
@endcan

@can('edit_perangkat')
<!-- modal edit -->@include('pages.perangkats.modal-edit')
<!-- end modal edit -->
@endcan

<!-- modal detail -->@include('pages.perangkats.modal-detail')
<!-- end modal detail -->
@can('delete_perangkat')
...
var table = $('#table_datatables').DataTable({
    ...
    ajax: {
        url: '{{ route('perangkats.datatables') }}',
        type: 'POST',
    ...
    columns: [
        ...
        { data: 'no_keputusan_pengangkatan', name: 'no_keputusan_pengangkatan' },
        { data: 'tanggal_keputusan_pengangkatan', name: 'tanggal_keputusan_pengangkatan' },
        { data: 'no_keputusan_pemberhentian', name: 'no_keputusan_pemberhentian' },
        { data: 'tanggal_keputusan_pemberhentian', name: 'tanggal_keputusan_pemberhentian' },
        { data: 'status_pejabat', name: 'status_pejabat' },
