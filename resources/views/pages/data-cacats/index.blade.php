 ...
 */
?>
@extends('layouts.app', ['title' => __('data_cacat') ])
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ __('data_cacat') }}</div>
            </div>
        </div>
                        ...
                        <div class="mb-3 row">
                            <div class="col-sm-12 col-md-6">
                                ...
                                <button type="button" class="btn btn-icon icon-left btn-primary mr-2"
                                    ...
                                    {{ __('site.add') }} {{ __('data_cacat') }}
                                </button>
                                @endcan

                                @can('trash_data_cacat')
                            ...
                            <form action="{{ route('data-cacats.excel') }}" method="POST">
                                    @csrf
                                ...
                                <form action="{{ route('data-cacats.print') }}" target="_blank" method="POST">
                                    @csrf
                                ...
                                <form action="{{ route('data-cacats.pdf') }}" method="POST">
                                    @csrf
...
@can('create_data_cacat')
<!-- modal add -->@include('pages.data-cacats.modal-add')
<!-- end modal add -->
@endcan

@can('edit_data_cacat')
<!-- modal edit -->@include('pages.data-cacats.modal-edit')
<!-- end modal edit -->
@endcan

<!-- modal detail -->@include('pages.data-cacats.modal-detail')
<!-- end modal detail -->
@can('delete_data_cacat')
...
var table = $('#table_datatables').DataTable({
    ...
    ajax: {
        url: '{{ route('data-cacats.datatables') }}',
        type: 'POST',
