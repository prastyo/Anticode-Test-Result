 ...
 */
?>
@extends('layouts.app', ['title' => __('data_agama') ])
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ __('data_agama') }}</div>
            </div>
        </div>
                        ...
                        <div class="mb-3 row">
                            <div class="col-sm-12 col-md-6">
                                ...
                                <button type="button" class="btn btn-icon icon-left btn-primary mr-2"
                                    ...
                                    {{ __('site.add') }} {{ __('data_agama') }}
                                </button>
                                @endcan

                                @can('trash_data_agama')
                            ...
                            <form action="{{ route('data-agamas.excel') }}" method="POST">
                                    @csrf
                                ...
                                <form action="{{ route('data-agamas.print') }}" target="_blank" method="POST">
                                    @csrf
                                ...
                                <form action="{{ route('data-agamas.pdf') }}" method="POST">
                                    @csrf
...
@can('create_data_agama')
<!-- modal add -->@include('pages.data-agamas.modal-add')
<!-- end modal add -->
@endcan

@can('edit_data_agama')
<!-- modal edit -->@include('pages.data-agamas.modal-edit')
<!-- end modal edit -->
@endcan

<!-- modal detail -->@include('pages.data-agamas.modal-detail')
<!-- end modal detail -->
@can('delete_data_agama')
...
var table = $('#table_datatables').DataTable({
    ...
    ajax: {
        url: '{{ route('data-agamas.datatables') }}',
        type: 'POST',
