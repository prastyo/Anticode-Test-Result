                ...
                <div class="card card-primary">
                    <div class="card-body">
                        <div class="mb-3 row">
                            ...
                            <form action="{{ route('users.excel') }}" method="POST">
                                    @csrf
                                ...
                                <form action="{{ route('users.print') }}" target="_blank" method="POST">
                                    @csrf
...
@can('create_users')
<!-- modal add -->@include('pages.users.modal-add')
<!-- end modal add -->
@endcan

@can('edit_users')
<!-- modal edit -->@include('pages.users.modal-edit')
<!-- end modal edit -->
@endcan

<!-- modal detail -->@include('pages.users.modal-detail')
<!-- end modal detail -->
@can('delete_users')
...
var table = $('#table_datatables').DataTable({
    ...
    columns: [
        ...
        { data: 'role_badge', name: 'role_badge', searchable: false, orderable: false, },
        { data: 'name', name: 'name' },
