 ...
 */
?>
@extends('layouts.app', ['title' => __('data_suku') ])
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ __('data_suku') }}</div>
            </div>
        </div>
                ...
                <div class="card card-primary">
                    <div class="card-body">
                        <div class="mb-3 row">
                            ...
                            <form action="{{ route('data-sukus.excel') }}" method="POST">
                                    @csrf
                                ...
                                <form action="{{ route('data-sukus.print') }}" target="_blank" method="POST">
                                    @csrf
                                ...
                                <form action="{{ route('data-sukus.pdf') }}" method="POST">
                                    @csrf
...
@can('create_data_suku')
<!-- modal add -->@include('pages.data-sukus.modal-add')
<!-- end modal add -->
@endcan

@can('edit_data_suku')
<!-- modal edit -->@include('pages.data-sukus.modal-edit')
<!-- end modal edit -->
@endcan

<!-- modal detail -->@include('pages.data-sukus.modal-detail')
<!-- end modal detail -->
@can('delete_data_suku')
...
var table = $('#table_datatables').DataTable({
    ...
    ajax: {
        url: '{{ route('data-sukus.datatables') }}',
        type: 'POST',
