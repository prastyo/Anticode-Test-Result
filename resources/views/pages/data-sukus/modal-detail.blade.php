    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mx-auto">{{ __('site.detail') }} {{ __('data_suku') }}</h5>
<!--
                ...
                <div class="row">
                    ...
                    <table class="table table-sm table_detail_left table-striped">
                        <tbody>
                            ...
                            <tr>
                                <td class="font-weight-bold">{{ __('deskripsi') }}</td>
                                <td>:</td>
                                <td id="deskripsi"></td>
                            </tr>
    ...
    $('#modal_detail').on('shown.bs.modal', function(event) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $(modale).find('#deskripsi').html(response.data.deskripsi);
